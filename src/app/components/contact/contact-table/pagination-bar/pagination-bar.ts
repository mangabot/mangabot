...
@Component({
    ...
    templateUrl: 'app/components/contact/contact-table/pagination-bar/pagination-bar.html',
    styleUrls: ['app/components/contact/contact-table/pagination-bar/pagination-bar.css']
})
